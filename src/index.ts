...
client.on('message', async (msg) => {
	...
	if(msg.author!.bot) {
		if (msg.channel.id === '763159605479079956' || msg.channel.id === '763081512752513084'){
			...
			//@ts-ignore
			if (msg.content.includes('SMH. Bot commands') || msg.content.includes('NSFW messages are not allowed') || msg.content.includes('vote')|| msg.content.includes('Please welcome the above user!')){
			    return;
			    }
